...
def _speak_blocking(text):
    # En Android no existen procesos externos (PowerShell/espeak/pyttsx3).
    # Si el TTS nativo no esta listo, se ignora en vez de intentar y colgarse.
    if platform == "android":
        print("[TTS] Android sin motor nativo listo. Texto:", text)
        return False
